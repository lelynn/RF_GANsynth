...
def select_type_inputs(type_input, gaus_expand_to_batch, mean_signals_expand_to_gaus, fixed_noise):
    '''
    ...
    if type_input == 'all_channels':
        ...
        inputs_g = (gaus_expand_to_batch * mean_signals_expand_to_gaus)
        
        inputs_n =  torch.cat((inputs_g , fixed_noise), dim=1)
    ...
    if type_input == 'V1_V4':
        ...
        inputs_g =  torch.stack((v1,v4), dim=1)
        inputs_n = torch.cat((inputs_g , fixed_noise), dim=1)
